...
float head = 0.0f;
float tail = 0.0f;
float rotDogX = 0.0f; //Sentar


//KeyFrames
//Posiciones del perro
float dogPosX , dogPosY , dogPosZ  ;

//Numero de keyframes maximos
#define MAX_FRAMES 9
//Identifica el tiempo o numero de keyframes actual
int i_max_steps = 400;
int i_curr_steps = 0;
//Variables que controlan el modelo
...
bool play = false;
int playIndex = 0;			//Keyframe actual

//Guarda informacion de cada keyframe
void saveFrame(void)
{
...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Animacion Keyframes Victor Manuel Torres Martinez", nullptr, nullptr);
	...
	//models
	Model DogBody((char*)"ModelsDogg/DogBody.obj");
	Model HeadDog((char*)"ModelsDogg/HeadDog.obj");
	Model DogTail((char*)"ModelsDogg/TailDog.obj");
	Model F_RightLeg((char*)"ModelsDogg/F_RightLegDog.obj");
	Model F_LeftLeg((char*)"ModelsDogg/F_LeftLegDog.obj");
	Model B_RightLeg((char*)"ModelsDogg/B_RightLegDog.obj");
	Model B_LeftLeg((char*)"ModelsDogg/B_LeftLegDog.obj");
