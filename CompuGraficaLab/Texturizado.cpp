...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Texturizado Victor Manuel Torres Martinez", nullptr, nullptr);
	...
	// Texture Coordinate attribute Enviamos indice de atributo de shader
	//2 por posicion, color texture color, tipo de dato,normalizacion de colores (false),
	//					numero de bits entre conjunto de atributos y al final apuntador
