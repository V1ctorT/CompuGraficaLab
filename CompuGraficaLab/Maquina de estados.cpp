...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Animacion maquina de estados Victor Manuel Torres Martinez", nullptr, nullptr);
	...
	Model Piso((char*)"ModelsDogg/piso.obj");
	Model Ball((char*)"ModelsDogg/ball.obj");
